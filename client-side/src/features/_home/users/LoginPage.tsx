...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Get values from form fields using form elements
    ...
    return (
        <section className="w-full">
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                >
                    <img
                        className="w-30 h-50 mb-[-60px]"
                        src="/assets/logo.svg"
                        alt="logo"
                    />
                </Link>
                <div className="w-full glass-container h-[45%] rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label
                                            htmlFor="remember"
                                            className="text-white-500 dark:text-gray-300"
                                        >
                                            Remember me
                                        </label>
                                    </div>
